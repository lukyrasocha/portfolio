	...
	return (
		<div className="w-full md:w-1/2">
			...
			<p className="font-mono pt-10 text-gray-400">
				...
				, I used Neural Cellular Automata (NCA) in the context of AI
				assisted procedural content generation. The aim was to automate
				...
				<a
					className="text-purple-500 hover:underline"
					href="https://github.com/interactive-nca"
					target="_blank"
					rel="noopener noreferrer"
				>
					GitHub
				...
				<a
					className="text-purple-500 hover:underline"
					href="https://zeldalevelcraft.com"
					target="_blank"
					rel="noopener noreferrer"
				>
					here
