	...
	return (
		<div className="w-full md:w-1/2">
			...
			<p className="font-mono pt-10 text-gray-400">
				...
				with four predefined personalities and optional user-customized
				bad habit tracking. The system allows users to easily track
				their daily moods and habits through a chat interface, and
				provides personalized visualizations in the dashboard to empower
				users in monitoring and enhancing their mental health.
				<br />
				<br />
				<Image
