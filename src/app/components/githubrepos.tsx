	...
	return (
		<div className="flex flex-col items-center w-full mt-10">
			...
			>
				{isVisible
					? "Hide my repos"
					: "Show the rest of my repositories"}
			</button>
			{isVisible && (
				<div>
					{repos.map((repo, index) => (
						<div className="indicator flex flex-col items-center w-full font-mono">
							<div
								key={index}
								className="collapse collapse-arrow border border-primary bg-base-400 mt-2"
							>
								<input type="checkbox" />
								...
								<div className="collapse-content">
									...
									<a
										className="transition-colors duration-400 hover:text-purple-500 text-sm"
										href={repo.html_url}
										target="_blank"
										rel="noopener noreferrer"
									>
